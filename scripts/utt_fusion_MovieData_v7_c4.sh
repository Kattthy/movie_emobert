...
cmd="python train_baseline_nocv.py --dataset_mode=MovieData_v7_c4_multimodal --model=utt_fusion
...
--name=MovieData_v7_c4_concat_5e-4 --suffix={modality}_run{run_idx}
--cvNo=$i"
...
#运行命令：bash scripts/utt_fusion_MovieData_v7_c4.sh AVL 1 0。表示跑AVL三模态融合的实验, 实验编号是1, 在0号卡上跑