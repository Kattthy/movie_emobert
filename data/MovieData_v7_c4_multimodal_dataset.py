...
class MovieDataV7C4MultimodalDataset(BaseDataset):
    @staticmethod
    ...
    def __init__(self, opt, set_name):
        ''' MovieData_v7_c4 dataset reader
        ...
        config = json.load(open(os.path.join(pwd, 'config', 'MovieData_v7_c4_config.json')))
        ...
        print(f"MovieData_v7_c4 dataset {set_name} created with total length: {len(self)}")
...
if __name__ == '__main__':
    ...
    a = MovieDataV7C4MultimodalDataset(opt, set_name='trn')
    data = next(iter(a))
