...
class MovieDataV7MultimodalDataset(BaseDataset):
    @staticmethod
    ...
    def __init__(self, opt, set_name):
        ...
        config = json.load(open(os.path.join(pwd, 'config', 'MovieData_v7_config.json')))
...
if __name__ == '__main__':
    ...
    a = MovieDataV7MultimodalDataset(opt, set_name='trn')
    data = next(iter(a))
