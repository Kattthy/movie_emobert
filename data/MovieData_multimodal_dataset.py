...
class MovieDataMultimodalDataset(BaseDataset):
    @staticmethod
    ...
    def __init__(self, opt, set_name):
        ...
        print(f"MovieData dataset {set_name} created with total length: {len(self)}")
...
if __name__ == '__main__':
    ...
    a = MovieDataMultimodalDataset(opt, set_name='trn')
    data = next(iter(a))
