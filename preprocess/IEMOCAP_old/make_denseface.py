...
import sys
sys.path.append('/data8/hzp/MEmoBert/preprocess')
from denseface_tf.dense_net import DenseNet
...
class DensefaceExtractor(object):
    ...
    def __init__(self, mean=129.7675, std=47.904685, device=0):
...
def split_cv(config):
    ...
    for cv in range(1, 11):
        save_dir = os.path.join(config['feature_root'], 'V', 'denseface', str(cv))
